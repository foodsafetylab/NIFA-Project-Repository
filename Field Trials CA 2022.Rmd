...
#leveneTest(APClm)
APC_Hydration_Effect<-anova(lm_APC_drywet) #effect in wet-dry p<6.753-6 -- poshoc test needed
APC_Pressure_Effect<-anova(lm_APC_press)#no effect from pressure
APC_BothFactors<-anova(lm_APC_2fac)#Hydration matters most 3.008e-5
APC_Zone_Effect<-anova(locAPClm) #zones had no effect
APC_InPlantLoc_effect<-anova(plantAPClm)#place in plant had no effect

lm_Colif_drywet<-lm(Log.Coli. ~ Wet.dry, data=Only_Swabs)
lm_Colif_press<-lm(Log.Coli. ~ Hand.msd, data=Only_Swabs)
lm_Colif_2fac<-lm(Log.Coli.~Hand.msd*Wet.dry, data=Only_Swabs)
locColiflm<-lm(Log.Coli.~ Wet.dry*Zone*Hand.msd, data=Only_Swabs)
plantColiflm<-lm(Log.Coli. ~ Hand.msd*Wet.dry*Top.bottom, data=Only_Swabs)
#shapiro.test(residuals(lm_APC))##normatility p=0.017
#leveneTest(lm_APC)#heterogenous p=0.03
#leveneTest(APClm)
Colif_Hydration_Effect<-anova(lm_Colif_drywet) #effect in wet-dry p<6.753-6 -- poshoc test needed
Colif_Pressure_Effect<-anova(lm_Colif_press)#no effect from pressure
Colif_BothFactors<-anova(lm_Colif_2fac)#Hydration matters most 3.008e-5
...
```{r}
knitr::kable(APC_Hydration_Effect)
knitr::kable(APC_Pressure_Effect)
knitr::kable(APC_BothFactors)
knitr::kable(APC_Zone_Effect)
knitr::kable(APC_InPlantLoc_effect)

knitr::kable(Colif_Hydration_Effect)
knitr::kable(Colif_Pressure_Effect)
