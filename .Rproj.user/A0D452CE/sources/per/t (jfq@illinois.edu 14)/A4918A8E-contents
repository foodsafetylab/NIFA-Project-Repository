...
ggsave("Swab-characterization.tiff",device = "tiff", dpi=300, path = "C:/Users/jorge/Box Sync/NIFA Project/NIFA Project Repository/Output 2022", height= 4, width= 8, units = "in")
ggsave("Swab-characterization.jpeg", device = "jpeg", dpi=300, path = "C:/Users/jorge/Box Sync/NIFA Project/NIFA Project Repository/Output 2022", height= 4, width= 8, units = "in")
...
ggsave("Swab-v-Produce.tiff",device = "tiff", dpi=300, path = "C:/Users/jorge/Box Sync/NIFA Project/NIFA Project Repository/Output 2022", height= 4, width= 6, units = "in")
ggsave("Swab-v-Produce.jpeg",device = "jpeg", dpi=300, path = "C:/Users/jorge/Box Sync/NIFA Project/NIFA Project Repository/Output 2022", height= 4, width= 6, units = "in")
...
OvPH_MT_pressure_hyd<-ggplot(data= Only_Swabs_noEcoli, aes(x=Hand.msd, y=Best..Estimate, col= Wet.dry))+
  ...
  labs(col="Hydration Factor", labels=c("MSD", "Hand"))+
  ggtitle("Overall PreHarvest Bacterial Recovery Comparison of Aggregative Swabs - Trials 2022")
OvPH_MT_pressure_hyd+facet_grid(.~ Test)

ggsave("Swab-characterization-overall.tiff",device = "tiff", dpi=300, path = "C:/Users/jorge/Box Sync/NIFA Project/NIFA Project Repository/Output 2022", height= 4, width= 8, units = "in")
ggsave("Swab-characterization-overall.jpeg", device = "jpeg", dpi=300, path = "C:/Users/jorge/Box Sync/NIFA Project/NIFA Project Repository/Output 2022", height= 4, width= 8, units = "in")
